    ...
    <Container className='fluid' style={{ backgroundColor: '#fff', display: 'flex', flex: 1, flexDirection: 'column' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'row', marginBottom: 10 }}>
          <span
            style={{
              ...
              marginBottom: 10,
              fontWeight: '600',
              color: question.titleQuestion[0].color,
            }}>
            {question.titleQuestion[0].num}
      </span>
          <span style={{ color: question.titleQuestion[0].color, fontSize: 25, fontWeight: '600', marginLeft: 10 }}>{question.titleQuestion[0].title}</span>
        </div>
      </Row>
      <Row className='d-flex justify-content-center' style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <Col className='d-initial justify-content-center' style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          <div style={{ display: 'flex', flexDirection: 'row', marginBottom: 10 }}>
            <span style={{ color: 'black', fontSize: 25, fontWeight: '600', marginLeft: 10 }}>{question.titleQuestion[0].text}</span>
          </div>
