    ...
    <Container className='fluid' style={{ backgroundColor: '#fff', display: 'flex', flex: 1, flexDirection: 'column' }}>
      <Row style={{ display: 'flex' }}>
        <div style={{ display: 'flex', flexDirection: 'row', marginBottom: 10 }}>
          ...
          <span style={{ color: '#33B1D6', fontSize: 25, fontWeight: '600', marginLeft: 10 }}>PRONUNCIATION: /ə/ sound in comparatives</span>
        </div>
      </Row>
      <div style={{ display: 'flex', marginLeft: 50, flexDirection: 'column' }}>
        <div style={{ display: 'flex', flexDirection: 'row', marginBottom: 10 }}>
          <span style={{ color: 'black', fontSize: 25, fontWeight: '600', marginLeft: 10 }}>Listen and repeat the examples.</span>
        </div>
        <div style={{ display: 'flex', flexDirection: 'row', marginBottom: 10 }}>
          <span style={{ fontSize: 25, marginBottom: 10, color: 'black', }}>1 </span>
          <span style={{ color: 'black', fontSize: 25, marginLeft: 10 }}>saf<u>er</u></span>
        </div>
        <div style={{ display: 'flex', flexDirection: 'row', marginBottom: 10 }}>
